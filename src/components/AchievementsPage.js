...
const AchievementsPage = ({ language, user, newlyUnlockedAchievements = [] }) => {
  ...
  const achievements = [
    ...
    { id: 'streak_3', icon: '🔥', title: { en: '3 Correct in a Row', ta: '3 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 3 questions correctly in a row', ta: 'தொடர்ச்சியாக 3 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_5', icon: '🌟', title: { en: '5 Correct in a Row', ta: '5 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 5 questions correctly in a row', ta: 'தொடர்ச்சியாக 5 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_10', icon: '💫', title: { en: '10 Correct in a Row', ta: '10 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 10 questions correctly in a row', ta: 'தொடர்ச்சியாக 10 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_15', icon: '🌠', title: { en: '15 Correct in a Row', ta: '15 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 15 questions correctly in a row', ta: 'தொடர்ச்சியாக 15 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_20', icon: '🌌', title: { en: '20 Correct in a Row', ta: '20 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 20 questions correctly in a row', ta: 'தொடர்ச்சியாக 20 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_25', icon: '🌌', title: { en: '25 Correct in a Row', ta: '25 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 25 questions correctly in a row', ta: 'தொடர்ச்சியாக 25 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
    { id: 'streak_30', icon: '🌌', title: { en: '30 Correct in a Row', ta: '30 தொடர்ச்சியான சரியான பதில்கள்' }, description: { en: 'Answer 30 questions correctly in a row', ta: 'தொடர்ச்சியாக 30 கேள்விகளுக்கு சரியான பதில் அளிக்கவும்' } },
